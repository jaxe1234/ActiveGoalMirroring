...
class OvercookedEnvironment(gym.Env):
            ...
            for line in file:
                ...
                # Phase 1: Read in kitchen map.
                    ...
                    for x, rep in enumerate(line):
                        # Object, i.e. Tomato, Lettuce, Onion, Cucumber, or Plate.
                        if rep in 'tlocp':
    ...
    def is_collision(self, agent1_loc, agent2_loc, agent1_action, agent2_action, print_enabled=False):
        ...
        if print_enabled:
            print(F"After collide adjust: Agent1_loc: {agent1_loc}, agent1_action: {agent1_action}, agent1_next_loc: {agent1_next_loc}, agent2_loc: {agent2_loc}, agent2_action: {agent2_action}, agent2_next_loc: {agent2_next_loc}")
        ...
        elif ((agent1_loc == agent2_next_loc) or
                (agent2_loc == agent1_next_loc)):
            execute[0] = False
            execute[1] = False
        if print_enabled:
            print(F"Execute array inner {execute}")
        return execute
